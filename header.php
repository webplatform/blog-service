...
<body <?php body_class(); ?>>
<header id="mw-head" role="banner">
	<div class="container">
		<!-- logo -->
		<div id="p-logo">
			 <a href="http://www.webplatform.org/"title="Visit the main page"></a>
		</div>
		<!-- /logo -->	
		<?php get_search_form(); ?>
	</div>
...
<nav id="sitenav">
   <div class="container">
      <ul class="links">
        ...
        <li><a href="http://docs.webplatform.org/wiki/WPD:Contributors_Guide">Contribute</a></li>
