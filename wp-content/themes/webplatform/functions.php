...
function twentyeleven_content_nav( $nav_id ) {
	...
	if ( $wp_query->max_num_pages > 1 ) : ?>
		<nav id="<?php echo $nav_id; ?>">
			...
			<div class="nav-previous" title="Older posts"><?php next_posts_link( __( '◀', 'twentyeleven' ) ); ?></div>
			<div class="nav-next" title="Newer posts"><?php previous_posts_link( __( '▶', 'twentyeleven' ) ); ?></div>
		</nav><!-- #nav-above -->
	<?php endif;
}
